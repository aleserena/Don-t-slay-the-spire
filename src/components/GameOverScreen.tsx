        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 12px 24px rgba(39, 174, 96, 0.4)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0) scale(1)';
              e.currentTarget.style.boxShadow = '0 8px 16px rgba(39, 174, 96, 0.3)';
            }}
          >
            🔄 Try Again
          </button>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = 'translateY(-3px) scale(1.05)';
              e.currentTarget.style.boxShadow = '0 12px 24px rgba(149, 165, 166, 0.4)';
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = 'translateY(0) scale(1)';
              e.currentTarget.style.boxShadow = '0 8px 16px rgba(149, 165, 166, 0.3)';
            }}
          >
            🏠 Main Menu
          </button>
