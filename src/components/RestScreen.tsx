      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            You find a peaceful campfire. The warmth soothes your mind and offers you a choice.
            <br /><br />
            <strong style={{ color: '#96ceb4' }}>Choose your rest activity:</strong>
          </div>
          ...
          <div style={{
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = '0 8px 16px rgba(150, 206, 180, 0.4)';
            }}
            onMouseLeave={(e) => {
            ...
            onClick={upgradableCards.length > 0 ? openCardUpgradeModal : undefined}
            onMouseEnter={(e) => {
