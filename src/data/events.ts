  ...
  return [
    {
      id: 'golden_idol',
      name: 'Golden Idol',
      description: 'You come across a golden idol sitting on a pedestal. It gleams with an otherworldly light.',
      choices: [
        {
          id: 'take_idol',
          text: 'Take the idol',
    ...
    },
    {
      ...
      description: 'A strange, pulsing sphere hovers before you. You sense great power within.',
      choices: [
        {
          id: 'touch_sphere',
    ...
    },
    {
      id: 'old_beggar',
      name: 'Old Beggar',
      description: 'An old beggar approaches you, asking for help. He looks desperate.',
      choices: [
        {
          id: 'give_gold',
    ...
    },
    {
      ...
      description: 'You discover ancient writing on the wall. The text seems to shift and change as you read.',
      choices: [
        {
          id: 'study_writing',
    ...
    },
    {
      id: 'fountain',
      name: 'Fountain',
      description: 'A pristine fountain bubbles with crystal clear water. You feel refreshed just looking at it.',
      choices: [
        {
          id: 'drink_water',
    ...
    },
    {
      ...
      description: 'You come across the remains of another adventurer. Their belongings are scattered around.',
      choices: [
        {
          id: 'search_body',
